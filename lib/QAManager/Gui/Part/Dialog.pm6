...
#-------------------------------------------------------------------------------
=begin pod
Purpose of this class is to be a base class for all dialogs (except from other gtk modules like MessageDialog or AboutDialog) used in this application and library so as to show a uniform look. There is a content area and a button area, which are free to fill in.
=end pod

unit class QAManager::Gui::Part::Dialog:auth<github:MARTIMM>;
